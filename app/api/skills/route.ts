...
const DEFAULT_SKILLS = [
  ...
  },
  {
    ...
    level: 90,
    description:
      "Systematic risk identification using STRIDE, MITRE's CAPEC, ATT&CK, and LINDDUN frameworks.",
    category: "Defensive Security",
    icon: "🎯",
    order: 2,
  },
  ...
  },
  {
    ...
    name: "MITRE ATT&CK",
    level: 82,
    description: "Framework for adversary tactics, techniques, and procedures.",
    category: "Methodologies & Frameworks",
    icon: "🎯",
    order: 20,
  },
  {
    ...
    name: "MITRE CAPEC",
    description:
      "Common Attack Pattern Enumeration and Classification — a dictionary of known attack patterns used to classify how adversaries exploit weaknesses in applications and systems.",
    level: 85,
    category: "Methodologies & Frameworks",
    icon: "🗂️",
    order: 21,
  },
  {
    ...
    name: "DREAD",
    description:
      "Risk rating model for quantifying and prioritizing security threats across Damage potential, Reproducibility, Exploitability, Affected users, and Discoverability.",
    level: 82,
    category: "Methodologies & Frameworks",
    icon: "⚖️",
    order: 22,
