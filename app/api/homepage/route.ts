...
export async function GET() {
  try {
    ...
    const defaultContent = {
      ...
      about: {
        title: 'Specialized in Web Application Offensive Security',
        description: 'I specialize exclusively in offensive security testing of web applications. Through deep reconnaissance, comprehensive enumeration, and thorough vulnerability analysis, I identify and exploit security weaknesses in web apps before malicious actors can.\n\nMy expertise encompasses full-spectrum penetration testing of web applications—from manual exploitation techniques and custom tool development in Go to deep understanding of web architectures, authentication mechanisms, and OWASP Top 10 vulnerabilities. I focus on finding critical flaws that automated scanners miss.',
        features: [
      ...
      services: {
        ...
        description: 'Specialized in offensive security testing of web applications. I conduct comprehensive penetration testing to identify critical vulnerabilities through manual exploitation, deep vulnerability analysis, and custom tool development before malicious actors can exploit them.',
        services: [
          {
            icon: '🌐',
